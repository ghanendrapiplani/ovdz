 ...
 */
public class EpisodeAdapter extends RecyclerView.Adapter<EpisodeAdapter.HomeViewHolder> {

    private Map<String, ArrayList<HomeMoivesBean>> listMap;
    private Context context;
    private ArrayList<String> titleList;

    public EpisodeAdapter(Map<String, ArrayList<HomeMoivesBean>> listMap, Context context, ArrayList<String> titleList) {
    ...
    class HomeViewHolder extends RecyclerView.ViewHolder {
        ...
        public HomeViewHolder(View itemView) {
            ...
            viewMoreBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((MainActivity) context).goToGroupDetailsFragment(Constants.TV_SHOWS_TYPE, Constants.TV_SHOW_TYPE);
        ...
        public void bindData(int position) {
            ...
            if (beanArrayList.size() > 0 && titleList.get(position).contains("LATEST TV SHOWS")) {
                SeasonAdapter itemAdapter = new SeasonAdapter(beanArrayList, context);
                moviesList.setAdapter(itemAdapter);
