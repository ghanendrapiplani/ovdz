 ...
 */
public class HomeMoiveItemAdapter extends RecyclerView.Adapter<HomeMoiveItemAdapter.ItemViewHolder> {

    private ArrayList<HomeMoivesBean> beanArrayList;
    private Context context;
    private ImageLoader imageLoader;

    public HomeMoiveItemAdapter(ArrayList<HomeMoivesBean> beanArrayList, Context context
            ) {
    ...
    public void onBindViewHolder(ItemViewHolder holder, int position) {
        ...
        if (type.equalsIgnoreCase("mp4Movies")) {
            ...
            loadMovieImage(imageUrl, holder.Image_mp4);
    ...
    private void loadMovieImage(String imageUrl, ImageView image_mp4) {
